...
FWM.datosBase.legal = {
  ...
  privacidad: {
    ...
    secciones: [
      ...
      { h: "Si nos informas de algo", p: "Si usas «Informar de un problema o sugerencia», se guarda lo que escribes, la versión del juego, el tipo de dispositivo y, si es un problema, cómo estaba tu partida en ese momento (el tablero, no datos tuyos). Solo lo usamos para arreglar y mejorar el juego." },
      ...
      { h: "Compras", p: "Las facciones se compran con Google Play o la App Store, y son ellas las que cobran: nunca vemos tu tarjeta. Para saber qué has comprado usamos RevenueCat, que recibe un identificador anónimo (o el de tu cuenta, si tienes) y la lista de tus compras, nunca tus datos de pago." },
  ...
  condiciones: {
    ...
    secciones: [
      ...
      { h: "Compras", p: "El juego es gratis con dos facciones. Las otras cinco se venden en las tiendas de aplicaciones (Google Play y App Store) y también se pueden conseguir con oro del héroe. Una compra es una licencia para usar esa facción en el juego mientras el juego exista; las devoluciones siguen las normas de cada tienda. Puedes recuperar tus compras desde la tienda de facciones." },
