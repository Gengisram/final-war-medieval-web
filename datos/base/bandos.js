...
//   { tipo: "coste_asentamiento", asentamiento: "castillo", recurso: "oro", factor: 0.75 }
...
FWM.datosBase.bandos = {
  castilla: {
    ...
    rasgo: "Los castillos cuestan un 25 % menos de oro.",
    ...
    bonos: [{ tipo: "coste_asentamiento", asentamiento: "castillo", recurso: "oro", factor: 0.75 }],
  ...
  portugal: {
    ...
    rasgo: "Campesinos: una casilla más y 3 de oro más baratos.",
  ...
  // Las hordas del modo Resistir. No es un bando jugable: no sale en los selectores (noJugable).
  hordas: {
    nombre: "Las hordas",
