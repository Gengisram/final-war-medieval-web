...
FWM.datosBase.facciones = {
  castilla: {
    ...
    unidad: "caballero_santiago", sinTropas: ["trabuco"],
  ...
  inglaterra: {
    ...
    rasgo: { nombre: "Tiradores", texto: "Todas tus tropas a distancia, +3 de ataque.", efectos: [{ tipo: "stat", etiqueta: "a_distancia", stat: "ataque", valor: 3 }] },
  ...
  mali: {
    ...
    descripcion: "Gana con la bolsa. Mansa Musa pasa por ser el hombre más rico de la historia: Malí saca más oro y lo gasta mejor. Su ejército es más numeroso aunque cada tropa pegue menos.",
    unidad: "jinete_mandinga", sinTropas: ["infanteria_pesada", "trabuco"],
    rasgo: { nombre: "Oro de Malí", texto: "Ganas un 8 % más de oro cada turno.", efectos: [{ tipo: "ingresos_factor", valor: 1.08 }] },
    poder: { id: "griots", nombre: "Los griots", texto: "Los cantores del Mansa levantan el ánimo: todas tus tropas recuperan 15 de vida al momento.", efecto: { curaTodas: 15 } },
    campana: "mali",
  },
  saladino: {
  ...
  mongoles: {
    ...
    poder: { id: "yam", nombre: "El Yam", texto: "La red de postas: este turno, todas tus tropas +2 de movimiento.", efecto: { movimiento: 2 } },
    campana: "mongoles",
  },
...
FWM.datosBase.escalera = [
  ...
  { nivel: 8, nombre: "Príncipe", puntos: 13000, tropas: ["trabuco"], marca: "hombreras" },
