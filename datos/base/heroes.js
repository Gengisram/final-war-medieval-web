...
FWM.datosBase.heroes = {
  ...
  clases: {
    ...
    mansa: {
      ...
      bonos: {}, defensaContra: {}, botin: 5, aura: { defensa: 1 },
      // 13 sep 2026: su aura era "las tropas pegadas no pagan mantenimiento" y en las simulaciones Malí ganaba 7 de cada 10
      rasgo: "Cada tropa enemiga que derrota: +5 de oro. Aura: +1 de defensa a las tropas pegadas.",
    },
    kan: {
      nombre: "Kan", descripcion: "Jinete y arquero. Dispara y se va antes de que le respondan. Los jinetes que cabalgan a su lado llegan más lejos.",
      stats: { ataque: 26, asedio: 0, defensa: 16, vida: 70, alcance: 1, movimiento: 3 },
      etiquetas: ["heroe", "montada", "a_distancia"],
      bonos: {}, defensaContra: {}, trasAtaque: "resto", aura: { movimientoMontada: 1 },
      rasgo: "Puede moverse después de disparar. Aura: los jinetes pegados, +1 de movimiento.",
    },
  ...
  mejoras: {
    ...
    // 18 sep 2026: con la tabla de valores del banco de pruebas. El ataque vale poco (el daño es ataque − defensa con
    // un mínimo de 10), así que Filo da +3 por peldaño; las auras, +2; lo que más vale (oro, aguante) sigue igual o baja.
    filo: { nombre: "Filo", familia: "heroe", peldanos: 3, efecto: { ataque: 3 }, texto: "+3 de ataque del héroe", adorno: "arma" },
...
FWM.heroes = (function () {
  ...
  function auraDe(heroe) {
    ...
    return {
      ...
      movimientoMontada: base.movimientoMontada || 0, sinMantenimiento: !!base.sinMantenimiento, mantenimientoMenos: base.mantenimientoMenos || 0, // Kan y Mansa
    };
  }
