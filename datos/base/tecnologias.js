...
//   { tipo: "produccion_yacimiento", yacimiento: "mina_oro", recurso: "oro", valor: 1 }
...
FWM.datosBase.tecnologias = {
  ...
  canteria: {
    nombre: "Cantería",
    descripcion: "El oficio de la piedra: abre las fortificaciones y las carreteras.",
    requiere: [],
    coste: { oro: 20 },
    turnos: 3,
    repetible: false,
  ...
  maquinaria: {
    nombre: "Maquinaria",
    descripcion: "Poleas y engranajes: abre las catapultas.",
    requiere: [],
    coste: { oro: 20 },
    turnos: 3,
    repetible: false,
