...
FWM.datosBase.medallas = [
  ...
  { id: "tres_bandos", nombre: "Diplomático", icono: "banderines", descripcion: "Gana con {n} facciones distintas.", niveles: [2, 4, 6], valor: (c) => Object.keys(c.r.ganadasPorBando || {}).length, premio: { oro: [15, 50, 150], objeto: { nivel: 3, id: "capa_embajador" } } },
