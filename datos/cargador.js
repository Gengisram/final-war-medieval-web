...
FWM.cargador = (function () {
  ...
  function validar(d) {
    ...
    for (const [id, f] of Object.entries(FWM.datosBase.facciones || {})) {
      if (!d.tropas[f.unidad] || d.tropas[f.unidad].faccion !== id) errores.push("facción " + id + ": unidad propia desconocida " + f.unidad);
      for (const t of f.sinTropas) if (!d.tropas[t]) errores.push("facción " + id + ": tropa desconocida " + t);
      if (!d.bandos[f.bando]) errores.push("facción " + id + ": bando desconocido " + f.bando);
    }
  ...
  function cargar(mods) {
    ...
    d.nombresPorCultura = FWM.datosBase.nombresPorCultura || {};
    ...
    for (const [clase, c] of Object.entries((d.heroes && d.heroes.clases) || {})) {
      d.tropas["heroe_" + clase] = { nombre: c.nombre, descripcion: c.descripcion, etiquetas: c.etiquetas.slice(), stats: Object.assign({}, c.stats), bonos: Object.assign({}, c.bonos || {}), defensaContra: Object.assign({}, c.defensaContra || {}),
        ...
        trasAtaque: c.trasAtaque || null, botin: c.botin || 0, cura: c.cura || 0 };
    }
    // las facciones y su escalera (13 sep 2026)
    d.facciones = FWM.datosBase.facciones || {}; d.escalera = FWM.datosBase.escalera || [];
