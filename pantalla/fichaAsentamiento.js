  ...
  function render(App, hex) {
    ...
    if (mio) {
      ...
      for (const tipo of tipos) {
        ...
        ficha.appendChild(FWM.iconos.canvasTropa(dt.icono, j.color, 36, false, j.faccion));
    ...
    for (let i = 0; i < huecosG; i++) {
      ...
      if (id) {
        ...
        d.appendChild(dt.heroe ? FWM.figuras.canvasHeroe(Object.assign({ faccion: j.faccion }, j.heroe), j.color, 40, false, tr.dueno !== App.humano) : FWM.iconos.canvasTropa(dt.icono, j.color, 40, tr.dueno !== App.humano, j.faccion));
