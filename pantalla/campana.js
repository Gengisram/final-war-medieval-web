...
FWM.campana = (function () {
  ...
  function opciones(id, bando) {
    const cap = capitulo(id); if (!cap) return null;
    return { tipo: "campana", capitulo: cap.id, mapaHecho: cap.mapa, rivales: cap.rivales, dificultad: cap.dificultad, limite: cap.limite, hucha: cap.hucha || 2, tecnologia: "todo", recursos: "equilibrado", bando: bando || "aleatorio", semilla: 5000 + cap.id * 17, jefe: cap.jefe || null };
  }
